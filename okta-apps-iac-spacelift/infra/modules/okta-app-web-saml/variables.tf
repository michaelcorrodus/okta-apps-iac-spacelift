...
variable "name_id_format" { type = string default = "urn:oasis:names:tc:SAML:1.1:nameid-format:emailAddress" }
variable "signature_algorithm" { type = string default = "RSA_SHA256" }
variable "digest_algorithm" { type = string default = "SHA256" }
